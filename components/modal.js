...
export default function Modal() {
  ...
  const updateTooltipCoords = (button) => {
    ...
    setCoords({
      ...
      top: rect.y + window.scrollY + rect.height + 5, // add scrollY offset, as soon as getBountingClientRect takes on screen coords
    });
  };
    ...
    <ClientOnlyPortal selector='#modal'>
      ...
      <style jsx>{`
        ...
        .buttonPrimary {
          ...
          position: relative;
          z-index: 10;
          box-shadow: rgba(0, 0, 0, 0.1) 0px 0.796875px 0.6666666865348816px 0px,
